        ...
        <section class="content content-home main__content-home">
            ...
            <div class="content-descr">
                ...
                <p class="content-descr__about">
                    В процессе вы узнаете много новых и интересных фактов о птицах: их размеры, места обитания, привычки, а самое главное - как звучат их голоса! 🤓<br><br>
                    Это отличная игра для тех, кто:<br>
                    😊 ценит окружающий его мир и хочет быть ближе к природе;<br>
                    👩‍🎓 интересуется орнитологией и хочет проверить свои знания;<br>
                    🤩 хочет весело провести время и любит квизы!<br><br>
                    Не теряй время зря! Пора начинать игру! 🥳
                </p>
